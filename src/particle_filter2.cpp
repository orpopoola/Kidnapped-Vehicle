...
void ParticleFilter::prediction(double delta_t, double std_pos[], 
  ...
  for (int i=0; i<num_particles;i++)
  {
    ...
    {
     new_x = particle[i].x + velocity*(sin(particles[i].theta+yaw_rate*delta_t - sin(particle[i].theta))/yaw_rate;
     new_y = particle[i].y + velocity*(cos(particle[i].theta) - cos(particle[i].theta + yaw_rate*delta_t))/yaw_rate;
     new_theta = particle[i].theta + yaw_rate*delta_t;
    }
    //adding noise
